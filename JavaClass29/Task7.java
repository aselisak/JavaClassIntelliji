...
public class Task7 {
    public static void main(String[] args) {
        ...
        //Each student object should have named and studentID. Display name of each student.
        Set<Student> students = new HashSet<>();//polymorphism
        students.add(new Student("Maha","123"));
        students.add(new Student("Habib","12345"));
        students.add(new Student("Asel","123654"));
