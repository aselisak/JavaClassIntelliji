...
public class Task3 {
    ...
    calculateSalePrice() which should be returning a price of the car.Create 2 subclasses: Sedan and Truck. The Truck
    ...
    own  implementation   of   calculateSalePrice(): if length of sedan is >20 feet then returned car price
