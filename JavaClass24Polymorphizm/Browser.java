...
public class Browser {
    ...
    void loadPage(String websiteLink){System.out.println("loading the website"+websiteLink);}
...
class GoogleChrome extends Browser{
    ...
    void closeBrowser(){System.out.println("Closing the GoogleChrome browser");}
}
class FireFox extends Browser{
    ...
    void closeBrowser(){System.out.println("Closing the FireFox browser");}
}
class Safari extends Browser{
    ...
    void closeBrowser(){System.out.println("Closing the Safari browser");}
}
class IE extends Browser{
    ...
    void closeBrowser(){  System.out.println("Closing the IE browser");}
    }
